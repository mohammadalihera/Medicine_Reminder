                  ...
                  Container(
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        UpdateDosageField(dosageGap: dosageGap, vitel: vitel, preDose: dosageNumber),
...
void addVital(Vitel vitel, int additionProgram, context) async {
  DateTime newMedicineDate = DateTime.fromMillisecondsSinceEpoch(int.parse(vitel.date.split(',').first));
